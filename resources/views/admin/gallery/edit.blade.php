...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" action="{{ route('gallery.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            @if(count($errors) > 0)
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <img id="preview" src="{{ url('assets/images/gallery/' . $data->image) }}" alt="Image Preview" width="200" />
                        </div>
                    </div>
                </div>  
                <!-- /.box-body -->
